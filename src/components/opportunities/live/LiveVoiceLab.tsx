      ...
      <div className="overflow-hidden rounded-tomorrow-lg border border-tomorrow-gold/35 bg-[linear-gradient(145deg,rgba(7,35,39,.96),rgba(4,19,21,.98))] shadow-[0_30px_90px_rgba(0,0,0,.28)]">
        <div className="border-b border-tomorrow-line px-5 py-5 sm:px-7">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <OpportunityBadge variant="package">Téo · íntimo & otimista</OpportunityBadge>
          </div>
          <h2 id="gpt-live-lab-title" className="mt-3 font-editorial text-3xl text-tomorrow-text sm:text-4xl">Téo · GPT-Live-1</h2>
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-tomorrow-muted">Preset oficial de teste travado: voz Tempo, sotaque paulista leve quase neutro, empolgação dobrada, espontaneidade extrema e uma conversa mais próxima, otimista e com poucas gírias.</p>
        </div>
        ...
        <div className="grid gap-6 p-5 sm:p-7 lg:grid-cols-[1fr_.78fr]">
          <div className="rounded-2xl border border-tomorrow-gold/25 bg-[radial-gradient(circle_at_top_left,rgba(212,175,55,.12),transparent_44%),rgba(4,16,18,.58)] p-5 sm:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <h3 className="mt-1 font-editorial text-2xl text-tomorrow-text">Téo · próximo, otimista e hiperempolgado</h3>
              </div>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-tomorrow-muted">A conversa deve parecer com alguém próximo e de confiança: calorosa, cúmplice, leve, divertida e muito empolgada. O sotaque paulista é só uma nuance; o Téo evita chiado e musicalidade carioca e usa gírias apenas pontualmente.</p>
            <div className="mt-5 flex flex-wrap gap-2 text-xs font-semibold">
              ...
              <span className="rounded-full border border-tomorrow-teal/25 bg-tomorrow-teal/8 px-3 py-1.5 text-tomorrow-teal-soft">Próximo & otimista</span>
          ...
          <div className="rounded-2xl border border-tomorrow-teal/25 bg-tomorrow-background/55 p-5">
            ...
            <dl className="mt-4 grid gap-3 text-sm">
              ...
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Sotaque</dt><dd className="font-semibold text-tomorrow-text">Paulista leve · quase neutro</dd></div>
              ...
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Proximidade</dt><dd className="font-semibold text-tomorrow-text">Íntima · otimista</dd></div>
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Gírias</dt><dd className="font-semibold text-tomorrow-text">Poucas · pontuais</dd></div>
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Prompt</dt><dd className="font-semibold text-tomorrow-gold">Téo próximo & hiperempolgado</dd></div>
            </dl>
            ...
            {lab.connected ? <p className="mt-4 text-center text-xs font-semibold text-tomorrow-teal-soft">Téo conectado com o preset íntimo, otimista e hiperempolgado.</p> : null}
        ...
        <div className="border-t border-tomorrow-line px-5 py-4 text-xs leading-relaxed text-tomorrow-muted sm:px-7">Preset travado: Tempo + paulista leve quase neutro + ritmo muito energético + empolgação x2 + espontaneidade extrema + proximidade íntima/otimista + poucas gírias. Para sentir mudanças, encerre a sessão anterior e inicie uma nova.</div>
      </div>
    </section>
  );
}
