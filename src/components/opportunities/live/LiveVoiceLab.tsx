  ...
  return (
    <section className="mx-auto w-full max-w-[90rem] px-4 py-8 sm:px-6 lg:px-8" aria-labelledby="gpt-live-lab-title">
      <div className="overflow-hidden rounded-tomorrow-lg border border-tomorrow-gold/35 bg-[linear-gradient(145deg,rgba(7,35,39,.96),rgba(4,19,21,.98))] shadow-[0_30px_90px_rgba(0,0,0,.28)]">
        ...
        <div className="grid gap-6 p-5 sm:p-7 lg:grid-cols-[1fr_.78fr]">
          <div className="rounded-2xl border border-tomorrow-gold/25 bg-[radial-gradient(circle_at_top_left,rgba(212,175,55,.12),transparent_44%),rgba(4,16,18,.58)] p-5 sm:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <h3 className="mt-1 font-editorial text-2xl text-tomorrow-text">Téo paulista · hiperempolgado</h3>
              </div>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-tomorrow-muted">A fala deve começar no teto de energia já na primeira palavra, manter ritmo elétrico e reagir de forma muito espontânea, informal e divertida. O sotaque é São Paulo capital/Grande SP, sem chiado ou musicalidade carioca.</p>
            <div className="mt-5 flex flex-wrap gap-2 text-xs font-semibold">
              <span className="rounded-full border border-tomorrow-teal/25 bg-tomorrow-teal/8 px-3 py-1.5 text-tomorrow-teal-soft">Empolgação extrema</span>
              ...
              <span className="rounded-full border border-tomorrow-teal/25 bg-tomorrow-teal/8 px-3 py-1.5 text-tomorrow-teal-soft">Informalidade extrema</span>
              <span className="rounded-full border border-tomorrow-teal/25 bg-tomorrow-teal/8 px-3 py-1.5 text-tomorrow-teal-soft">Paulista forte</span>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-tomorrow-teal/25 bg-tomorrow-background/55 p-5">
            ...
            <dl className="mt-4 grid gap-3 text-sm">
              ...
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Sotaque</dt><dd className="font-semibold text-tomorrow-text">Paulista forte · sem carioca</dd></div>
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Ritmo</dt><dd className="font-semibold text-tomorrow-text">Ágil · elétrico</dd></div>
              ...
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Informalidade</dt><dd className="font-semibold text-tomorrow-text">Extrema</dd></div>
              <div className="flex items-center justify-between gap-4"><dt className="text-tomorrow-muted">Prompt</dt><dd className="font-semibold text-tomorrow-gold">Téo paulista hiperativo</dd></div>
            </dl>
            ...
            {lab.connected ? <p className="mt-4 text-center text-xs font-semibold text-tomorrow-teal-soft">Téo conectado com o preset paulista hiperenergético.</p> : null}
        ...
        <div className="border-t border-tomorrow-line px-5 py-4 text-xs leading-relaxed text-tomorrow-muted sm:px-7">Preset travado: Tempo + paulista forte + ritmo elétrico + empolgação extrema + espontaneidade extrema + informalidade extrema. Para sentir mudanças, encerre a sessão anterior e inicie uma nova.</div>
      </div>
    </section>
  );
}
