  ...
  const handleWhatsappSubmit = async () => {
    ...
    if (pendingQuote) {
      supabase.from('quote_requests').insert({
        ...
        notes: `Cotação solicitada via Téo Site. Volta: ${pendingQuote.data_volta}. Adultos: ${pendingQuote.passageiros.adultos}, Crianças: ${pendingQuote.passageiros.criancas}${pendingQuote.passageiros.idades_criancas?.length ? ` (Idades: ${pendingQuote.passageiros.idades_criancas.join(', ')})` : ''}.`,
        status: 'pending',
