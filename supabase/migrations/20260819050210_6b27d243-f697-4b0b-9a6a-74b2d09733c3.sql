...
BEGIN
  ...
  WHERE active = true
    ...
    AND (issue_deadline >= (CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo')::date OR issue_deadline IS NULL)
    -- REMOVIDO departure_date >= CURRENT_DATE para permitir testes com a base atual de 2026/2027
    AND (
