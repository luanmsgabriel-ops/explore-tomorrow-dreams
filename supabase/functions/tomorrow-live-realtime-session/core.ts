...
const FOUNDATION_INSTRUCTIONS = [
  ...
  "Use requested_channel details somente quando o cliente pedir explicitamente para abrir, ver ou ser direcionado aos detalhes da oferta.",
  "Use requested_channel whatsapp somente quando o cliente pedir explicitamente para abrir, ir ou ser direcionado ao WhatsApp; escolher uma oferta sem pedir navegação não autoriza abrir o WhatsApp.",
  "Quando o cliente apenas escolher a oferta ou pedir mais informações sem escolher um canal, use requested_channel options e informe que os acessos foram apresentados na tela.",
  "Depois de requested_channel details ou whatsapp, informe que o canal pedido está sendo aberto. Nunca afirme que uma mensagem do WhatsApp foi enviada.",
...
const OFFER_ACTIONS_TOOL = {
  ...
  description: [
    ...
    "Use details ou whatsapp somente após um pedido explícito do cliente para abrir esse canal; nesses casos a interface iniciará a navegação.",
    "Use options quando ele apenas escolher a oferta ou pedir mais informações sem solicitar navegação. A ferramenta nunca envia mensagens automaticamente.",
  ].join(" "),
  parameters: {
    type: "object",
    additionalProperties: false,
    ...
    properties: {
      ...
      requested_channel: {
        ...
        description: "Canal explicitamente pedido pelo cliente; use options quando ele escolher a oferta ou pedir mais informações sem solicitar que um canal seja aberto.",
      },
    },
  },
} as const;
